...
Complexities:
  Time: O(n) where n is the maximum count of the symbol that is used to represent the number. (Inner for loop is the declarator of time complexity)
  Space; O(1)
Tryouts:
...
class Solution:
    def int_to_roman(self, num: int) -> str:
        ...
        # 1349
        for symbol, value in roman_table:
            if num // value != 0:
                count = num // value
...
def test_int_to_roman():
    ...
    num = 3749
    assert solution.int_to_roman(num) == "MMMDCCXLIX"
